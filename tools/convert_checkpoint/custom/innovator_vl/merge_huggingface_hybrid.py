...
def parse_args():
    ...
    group.add_argument('--siglip2_path', type=str, help="Path to siglip2 model.")
    group.add_argument('--dinov3_path', type=str, help="Path to dinov3 model.")
...
ricevit = load_huggingface_checkpoint(args.ricevit_path)
siglip2 = load_huggingface_checkpoint(args.siglip2_path)
dinov3 = load_huggingface_checkpoint(args.dinov3_path)
